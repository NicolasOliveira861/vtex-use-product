...
var RestricaoDeConculsao = function (funcaoDeAvaliacao,mensagemDeErro){
	var _this = this,
		_regraAtiva = true, _mensagemDeErro;
	...
	_this.mensagemDeErro = function (mensagemDeErro = 'Forneca as informações para finalizar a compra') {
		if (mensagemDeErro)
	...
	function atualizacaoDoPedido(event,orderform){
		...
		if(typeof ehAplicavel === "boolean"){
			...
			aplicavel(false);
			console.error("função de avaliação retornando resultado indefinido.\n",ehAplicavel);
		}
	}
